...
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  3.000 [get_ports {OTG_DATA*}]
set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  2.000 [get_ports {OTG_DATA*}]
...
set_input_delay -add_delay -max -clock [get_clocks {main_clk_50}]  3.000 [get_ports {SW*}]
set_input_delay -add_delay -min -clock [get_clocks {main_clk_50}]  2.000 [get_ports {SW*}]
...
set_output_delay -add_delay  -clock [get_clocks {main_clk_50}]  2.000 [get_ports {OTG_DATA*}]
...
set_false_path -from [get_ports CLOCK_50] -to *
